...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      "border-2 text-sm border-stone-200 uppercase font-semibold text-stone-400  inline-block tracking-wide rounded-full hover:bg-stone-300 transition-colors duration-300 focus:bg-stone-300 focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-5 md:py-3.5 hover:text-stone-800",
  };
  if (to) {
    return (
